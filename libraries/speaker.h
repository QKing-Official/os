...
// --- Raw frequency control ---
void speaker_play(uint32_t frequency);
void speaker_stop(void);
void speaker_beep(uint32_t freq, uint32_t ms);

// --- Notes ---
// Standard note names: NOTE_C4, NOTE_D4 ... NOTE_B4, NOTE_C5, etc.
// Octaves 2-7 supported. NOTE_REST = silence.
#define NOTE_REST 0
...
void speaker_set_bpm(uint32_t bpm);

// Config

#define DUR_WHOLE       4
#define DUR_HALF        2
#define DUR_QUARTER     1
#define DUR_EIGHTH_D    0
